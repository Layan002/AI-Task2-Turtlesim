...
# Important note 
I've notices that I can open more than one node for different distrobutions. As a result, I can control turtlesim node of ROS and turtilesim node of ROS 2 at the same time: 
